...
%global pkg_name rviz_2d_overlay_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-rolling-rviz-2d-overlay-msgs
Version:        1.3.0
Release:        2%{?dist}
...
%description
Messages describing 2D overlays for RVIZ, extracted/derived from the
jsk_visualization ROS1 packege.
...
%changelog
* Fri Mar 22 2024 Team Spatzenhirn <team-spatzenhirn@uni-ulm.de> - 1.3.0-2
